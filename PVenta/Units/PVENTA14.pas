...
begin
  ...
  QClientesCLI_PRECIO.Value := 'Precio1';
...
begin
  ...
  begin
    ...
    begin
      ShowMessage('El valor de b�squeda es nulo o vac�o.');
    end;
  end;
...
if not (dm.QParametrospar_inv_unidad_medida.Text = 'True') then begin
  DBComboBox1.Clear;
  DBComboBox1.Items.Add('Precio1');
  DBComboBox1.Items.Add('Precio2');
  DBComboBox1.Items.Add('Precio3');
  DBComboBox1.Items.Add('Precio4');
  end;

if (dm.QParametrospar_inv_unidad_medida.Value = 'True') then begin
  DBComboBox1.Clear;
  DBComboBox1.Items.Add('Precio');
  DBComboBox1.Items.Add('Credito');
  DBComboBox1.Items.Add('Minimo');
  end;
end;
