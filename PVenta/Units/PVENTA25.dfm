object frmDesembolsos: TfrmDesembolsos
  ...
  object QDesem: TADOQuery
    ...
    SQL.Strings = (
      'select '
      'd.CLI_CODIGO, DES_BENEFICIARIO, DES_CONCEPTO, '
      'DES_FECHA, DES_MONTO, DES_NUMERO, DES_STATUS, '
      'DEV_NUMERO, d.EMP_CODIGO, d.USU_CODIGO, CAJ_CODIGO, '
      'DES_CONCEPTO2, DES_CAJA, d.SUC_CODIGO, SUP_CODIGO,'
      'DES_DESCUENTO, des_tipo, des_ncf, rnc_empresa, tip_codigo,'
      
        'd.emp_numero, des_gasto_menor, des_itbis, e.emp_rnc, c.cli_rnc,e' +
        'NCF'
      'from '
      
        'DESEMBOLSOS d inner join Empresas e on d.emp_codigo= e.emp_codig' +
        'o'
      'left join clientes c on c.cli_codigo=d.cli_codigo'
      'where'
      'd.emp_codigo = :emp'
  ...
  object dsVerificarFP: TDataSource
    DataSet = QVerificarFP
    Left = 200
    Top = 256
  end
end
